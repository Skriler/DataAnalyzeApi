        ...
        new List<object[]>
        {
            ...
            new object[]
            {
                new AgglomerativeClustererTestCase
                {
                    ...
                    ExpectedClusterSizes = new List<int> { 1, 1, 1 },
                },
            },
            ...
            new object[]
            {
                new AgglomerativeClustererTestCase
                {
                    ...
                    ExpectedClusterSizes = new List<int> { 2, 1 },
                },
            },

            // Test Case 3: 3 objects with high threshold & 1 clusters
            new object[]
            {
                new AgglomerativeClustererTestCase
                {
            ...
            new object[]
            {
                new AgglomerativeClustererTestCase
                {
                    ...
                    ExpectedClusterSizes = new List<int> { 2, 1, 2 },
                },
            },
        };
}

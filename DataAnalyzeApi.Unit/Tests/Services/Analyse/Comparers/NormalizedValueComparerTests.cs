...
namespace DataAnalyzeApi.Unit.Tests.Services.Analyse.Comparers;
...
public class NormalizedValueComparerTests
{
    ...
    public void Compare_WhenNullOrEmptyStrings_ReturnsExpected(
        string? valueA,
        string? valueB,
        double range,
        double expected)
    ...
    [InlineData("-5", "5", 20.0, 0.5)]
    public void Compare_WhenNumericValues_ReturnsCorrect(
        string a,
        string b,
        double range,
        double expected)
    ...
    [InlineData("red, blue", "red,blue", 1.0)]
    public void Compare_WhenCategoricalValues_ReturnsExpected(
        string a,
        string b,
        double expected)
    {
